...
export const ExerciseCard: React.FC<ExerciseCardProps> = ({
    ...
    return (
        <div className="bg-white p-5 rounded-2xl mb-4 border border-[#E5E7EB] shadow-[0_4px_12px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)] hover:-translate-y-0.5 transition-all duration-300 flex flex-col group">
