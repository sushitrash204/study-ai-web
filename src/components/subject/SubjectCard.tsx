    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between relative z-10 w-full">
                <div className="w-12 h-12 bg-white/20 backdrop-blur-md rounded-[18px] flex items-center justify-center text-white border border-white/40 shadow-[0_8px_16px_rgba(0,0,0,0.1)] group-hover:animate-float">
            ...
            <div className="relative z-10 w-full transform group-hover:translate-x-1 transition-transform duration-300">
                <h4 className="text-[20px] md:text-[22px] font-extrabold text-white leading-tight drop-shadow-md line-clamp-2">{name}</h4>
